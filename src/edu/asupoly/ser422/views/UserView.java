...
public class UserView extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (session != null){
			...
			sb.append("<p>" + thePerson.toString() + "</p>");
			sb.append("<p><a href=\"\\lab2_tcotta\\welcome\">Back</a><br></p>");
			sb.append("<p><a href=\"\\lab2_tcotta\\usercontroller?id=" + thePerson.getID() + "&action2=remove\">Remove</a></p>");
			PrintWriter pw = response.getWriter();
